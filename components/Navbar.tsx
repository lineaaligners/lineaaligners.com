            ...
            <div className="flex items-center space-x-8">
              {content.nav.map((item) => (
                <a
                  ...
                  className="text-sm font-bold text-white/80 hover:text-white hover:text-[#87CEEB] transition-colors tracking-wide uppercase"
                >
                  {item.label}
                </a>
              ))}
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2 bg-white/5 p-1 rounded-xl border border-white/10">
                <button 
                  ...
                  className={`px-3 py-1 rounded-lg text-xs font-black transition-all ${language === 'en' ? 'bg-[#4169E1] text-white shadow-lg' : 'text-white/40 hover:text-white/70'}`}
                >
                  EN
                </button>
                <button 
                  onClick={() => setLanguage('sq')}
                  className={`px-3 py-1 rounded-lg text-xs font-black transition-all ${language === 'sq' ? 'bg-[#4169E1] text-white shadow-lg' : 'text-white/40 hover:text-white/70'}`}
                >
                  SQ
                </button>
              </div>
              ...
              <button 
                ...
                className="text-xs font-black text-white/70 uppercase tracking-widest hover:text-[#87CEEB] transition-colors"
              >
